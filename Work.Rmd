...
species_site_model <- brm(bf(virus_copies ~ 1 + site*species,
                  ...
                  data=site_data,
                  prior=c(prior(normal(0.7, 0.5), class="b"),
                         prior(normal(0.3, 0.8), class="Intercept"),
                         prior(normal(2, 0.5), class="b", coef="speciesanaxyrus_woodhousii"),
                         prior(normal(1.2, 0.5), class="b", coef="sitelost_lake"),
                         prior(normal(2,0.5), class="b", coef="siteNAB_2")),
                  sample_prior="only",
                  iter=1000, chains=2)
...
#Adding dpar=TRUE creates the column hu which contains the probability of detecting 0 ranavirus copies. The .epred column accounts for this probability.
